...
export default function Dashboard() {
  ...
  const { username } = JSON.parse(atob(localStorage.getItem('access_token')?.split('.')[1]));
  return (
    <main className="bg-gray-100 dark:bg-gray-800 h-screen overflow-hidden relative">
      <div className="flex items-start justify-between">
        <NavBar toggleMenu={toggleMenu} />
        <div className="flex flex-col w-full overflow-auto">
          <header className="w-full h-16 z-40 flex items-center justify-between shadow">
            ...
            <div className="relative z-20 flex flex-col justify-end px-3 md:w-full">
              <div className="relative p-1 flex items-center w-full space-x-4 justify-end">
                ...
                <a href="#" className="block relative">
                  <img alt="profil" src="https://randomuser.me/api/portraits/women/60.jpg" className="mx-auto object-cover rounded-full h-10 w-10 "/>
                </a>
